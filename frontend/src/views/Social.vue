...
<template>
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-screen-lg mx-auto px-4 py-4">
      <h2 class="text-lg font-bold text-gray-800 mb-4">社交</h2>
      ...
      <div class="space-y-3 mb-6">
        ...
        >
          ...
          <svg class="w-5 h-5 text-gray-300 ml-auto" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
      ...
      <div class="bg-white rounded-xl p-4 border border-gray-100">
        <h3 class="text-sm font-bold text-gray-700 mb-3">热门讨论</h3>
        ...
        <p v-else class="text-xs text-gray-400 text-center py-6">还没有帖子，快去球迷圈发表你的观点吧！</p>
      </div>
    </div>
  </div>
</template>
