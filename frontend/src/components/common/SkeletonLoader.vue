...
<template>
  <div class="animate-pulse">
    ...
    <template v-if="type === 'card' || !type">
      <div v-for="i in (count || 3)" :key="i" class="bg-white rounded-xl p-4 mb-3">
    ...
    <template v-if="type === 'list'">
      <div v-for="i in (count || 5)" :key="i" class="flex items-center gap-3 py-3 border-b border-gray-50">
    ...
    <template v-if="type === 'grid'">
      <div class="grid grid-cols-2 gap-3">
        <div v-for="i in (count || 6)" :key="i" class="bg-white rounded-xl p-4">
          <div class="w-10 h-10 bg-gray-200 rounded-full mb-3"></div>
          <div class="h-4 bg-gray-200 rounded w-3/4 mb-2"></div>
          <div class="h-3 bg-gray-100 rounded w-1/2"></div>
        </div>
      </div>
