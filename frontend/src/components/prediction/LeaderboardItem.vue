...
<template>
  <div class="flex items-center gap-3 py-3 px-4 hover:bg-gray-50 transition-colors rounded-lg">
    ...
    <div class="flex-1 min-w-0">
      <p class="text-sm font-medium text-gray-800 truncate">{{ props.entry.nickname }}</p>
      <div v-if="props.entry.win_streak >= 3" class="flex items-center gap-1 mt-0.5">
    ...
    <div class="text-right flex-shrink-0">
      <p class="text-sm font-bold text-gray-800">{{ props.entry.total_points }}</p>
