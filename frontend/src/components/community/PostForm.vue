...
<template>
  <div class="bg-white rounded-xl p-4">
    ...
    <!-- Image preview grid -->
    <div v-if="images.length > 0" class="flex gap-2 mt-3 flex-wrap">
      <div
    ...
    >
      <svg class="w-8 h-8 text-gray-300 mx-auto mb-1" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
